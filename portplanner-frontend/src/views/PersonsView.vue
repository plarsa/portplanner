    ...
    <div class="table-wrap">
      <table>
        <thead>
          <tr>
            <th>Namn</th>
            <th class="col-email">E-post</th>
            <th class="col-phone">Telefon</th>
            <th class="col-address">Adress</th>
            <th class="col-boats">Båtar</th>
          </tr>
        </thead>
        <tbody>
...
.detail-card { background: white; border-radius: 12px; width: 480px; max-width: 100%; height: min(85vh, 720px); display: flex; flex-direction: column; box-shadow: 0 8px 32px rgba(0,0,0,0.18); overflow: hidden; }
...
.detail-footer { flex-shrink: 0; padding: 0.9rem 1.4rem; border-top: 1px solid #eee; display: flex; justify-content: space-between; align-items: center; gap: 0.75rem; }
